...
@app.route("/cureprim", methods = ["GET", "POST"])
def cureprim():
    return render_template('cureprim.html')

@app.route("/predict", methods = ["GET", "POST"])
def predict():
    return render_template('predict.html')

@app.route("/curesec", methods = ["GET", "POST"])
def curesec():
    return render_template('curesec.html')

@app.route("/curecmp", methods = ["GET", "POST"])
def curecmp():
    return render_template('curecmp.html')
